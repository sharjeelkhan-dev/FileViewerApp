...
<img width="720" height="1600" alt="image" src="https://github.com/user-attachments/assets/2c2d1dcc-1043-47e2-975e-61c7ada02c9c" />
<img width="720" height="1600" alt="image" src="https://github.com/user-attachments/assets/17d34c21-fbdd-4e9f-9e1b-ec19c9b4741a" />
<img width="720" height="1600" alt="image" src="https://github.com/user-attachments/assets/b8bac030-f209-4a63-a7cc-2e40f740859b" />
<img width="720" height="1600" alt="image" src="https://github.com/user-attachments/assets/97585e07-25df-4cba-8c74-bd6292b71900" />
<img width="720" height="1600" alt="image" src="https://github.com/user-attachments/assets/05b123bb-9d83-4a9a-9f1c-e72dc90a8ec0" />
...
1.  **Clone the Repository**:
    ```bash
    git clone https://github.com/yourusername/fileviewerapp.git
    ```
2.  **Open in Android Studio**:
    Open the project in Android Studio Ladybug or newer.
3.  **Sync Gradle**:
    Let the project sync and download all necessary dependencies.
4.  **Run**:
    Deploy to a physical device or emulator running API 28 or higher.

---

Made with ❤️ by Sharjeel Khan
